...
const SkeletonBlock: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div
    className={`rounded-lg bg-[rgb(var(--color-card-muted-rgb,220,220,220))] overflow-hidden relative ${className}`}
...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ message, showSkeleton = true }) => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'var(--color-bg, #f7f6f2)' }}
    >
      <style>{`
      ...
      {/* Top progress bar */}
      <div className="w-full h-0.5 relative overflow-hidden" style={{ background: 'rgba(128,128,128,0.1)' }}>
        <div
      ...
      {showSkeletonUI ? (
        ...
        <div className="flex-1 overflow-hidden p-4 md:p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <FinTrackIcon className="h-8 w-8" style={{ color: 'var(--color-primary, #01696f)', opacity: 0.6 }} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="rounded-xl p-4 flex flex-col gap-2" style={{ background: 'rgba(128,128,128,0.07)' }}>
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 rounded-xl p-4 flex flex-col gap-3" style={{ background: 'rgba(128,128,128,0.07)' }}>
            ...
            <div className="rounded-xl p-4 flex flex-col gap-3" style={{ background: 'rgba(128,128,128,0.07)' }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 loading-brand">
          <FinTrackIcon
            className="h-16 w-16"
            style={{ color: 'var(--color-primary, #01696f)' }}
          />
          <p className="text-base font-semibold" style={{ color: 'var(--color-text-muted, #7a7974)' }}>
